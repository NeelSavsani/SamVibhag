...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // Controls the expandable search visibility mechanics
  ...
  void loadGroups() {
    ...
    final savedGroups = List<dynamic>.from(
      box.get(
        groupsKey,
        defaultValue: [],
      ),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              /// FIXED: SEARCH ICON WITH CIRCULAR BACKGROUND ON THE LEFT SIDE
              AnimatedSwitcher(
                ...
                child: _isSearchExpanded
                    ? TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            ...
                            onPressed: () {
                              // Safely un-focus keyboard before modifying state layout hierarchies
                    ...
                    : Align(
                        ...
                        alignment: Alignment.centerLeft, // FIXED: Aligned search action icon to the left side
