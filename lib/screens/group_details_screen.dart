  ...
  Future<void> shareSettlements() async {
    ...
    final message =
        settlements
            .map(
              (e) =>
                  "${e.from} pays ${e.to} : Rs. ${e.amount.toStringAsFixed(0)}",
            )
            .join("\n");
          ...
          children: [
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final balance =
                    widget.group.memberBalances[member] ??
                        0;
                ...
                if (isGets) {
                  ...
                  subtitle =
                      "Owes ₹ ${(-balance).toStringAsFixed(0)}";
